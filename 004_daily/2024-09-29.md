...
![[2024-09-28#Be Grateful!]]
### GTD & Top 3 Tasks
- [ ] 现代控制资料书过一遍，把书上题目写一写，加深理解
- [ ] 积分计算例题写完，总结计算的一些方法和典型例题
- [ ] 线代看没咋了视频第一章
- [ ] 阅读四篇（不要多要精，训练技巧）
---
...
### Be Grateful!
> 阅读没有细读早上看完，积分计算到了第八点后面没有细看，现代控制开了一个头，早上复习一下，线代直观理解视频还有一点没看，明天要看完，准备看没咋了了线代救命，快速过完知识点，现代控制大纲早上可以梳理一下，经典控制理论考虑一下是做真题还是习题册，
> 我是应该考一个好一点的学校上大，还是求稳，先有一个学上？
> 
...
```dataview
list
where file.cday = date(2024-09-29)
sort file.ctime asc
```
### Notes modified today
```dataview
list
where file.mday = date(2024-09-29)
sort file.mtime asc
```