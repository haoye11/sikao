...
## GET READY
### Yesterday task
- [>] [[2024-09-15|Yesterday]]
![[2024-09-15#Be Grateful!]]
### GTD & Top 3 Tasks
- [ ] 微分学应用二
- [ ] 校正和离散
- [ ] 阅读，单词
...
### Be Grateful!
> 只看完第一部分中值定理，离散还未开始，前面误差部分的理解不够，单词也没背，下午又一直在玩
...
```dataview
list
where file.cday = date(2024-09-16)
sort file.ctime asc
```
### Notes modified today
```dataview
list
where file.mday = date(2024-09-16)
sort file.mtime asc
```
