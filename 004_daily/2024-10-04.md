...
## GET READY
### Yesterday task
- [>] [[2024-10-03|Yesterday]]
![[2024-10-03#Be Grateful!]]
### GTD & Top 3 Tasks
- [ ] 几何应用，多元函数
- [ ] 向量
- [ ] 15年专业课真题，现控第二章节
...
### Be Grateful!
> 今天写了积分的几何应用，计算方面还是不足。也要开始复习之前的题目了。专业课就是对知识点不熟悉，有印象但是写不出来。线代看到了矩阵，明天看向量。
> 加油加油，保证在学习时的效率，确保每天的时长，收获还是很多的，然后就是把他变成总结成自己的，这点很重要。
...
```dataview
list
where file.mday = date(2024-10-04)
sort file.mtime asc
```