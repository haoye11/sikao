...
## GET READY
### Yesterday task
- [>] [[2024-09-14|Yesterday]]
![[2024-09-14#Be Grateful!]]
![[2024-09-14#GTD & Top 3 Tasks]]
### GTD & Top 3 Tasks
- [ ] 
- [ ] 
- [ ] 
...
```dataview
list
where file.cday = date(2024-09-15)
sort file.ctime asc
```
### Notes modified today
```dataview
list
where file.mday = date(2024-09-15)
sort file.mtime asc
```